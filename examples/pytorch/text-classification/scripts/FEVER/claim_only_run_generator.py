...
weak_models = {
    'claim_bias': {
        '5_epochs': ('batch_32/fever/claim_bias/extrensic_debiasing/claim_bert/5_epochs/2e5_bert', '5ClaimExtrensic')
    }
}

bias_indices_choices = {
    # 'bow': "data/fever_unknown_bias_splits/bow_1_epoch/train_biased_correct_indices.bin",
    'claim_bias': "data/fever_claim_bias_splits/5_folds_0.8_confidence/train_biased_correct_indices.bin",
}

bias_type = "claim_bias"
# ----------------------------------------------------------------------------------------------------------------------
# RUN PARAMETERS
bias_set_choice = "claim_bias"
