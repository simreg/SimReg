...
def main():
    ...
    debertav3 = False
    node_name = "galileo1"  # nlp-a40-1, galileo2, galileo1
    if debertav3:
        unbiased_models = {
        ...
        unbiased_models = {
            BiasType.LEXICAL: ('qqp_runs/extrensic_debiasing/lexical_bias/bert_64_0.6_lexical_extrensic_debiasing/checkpoint-6800', 'EDBXE'),
